	...
	return (
		<div>
			...
			<section className="relative h-screen flex items-center justify-center">
				<img src="/assets/images/blog-hero-bg.jpg" alt="" className="absolute bottom-0" />
			...
			<section className="relative flex flex-col items-center justify-center bg-black px-5 lg:px-10 py-10">
				...
				<div className="w-full lg:w-1/2 flex items-center bg-gray-900 rounded-full px-5 z-10">
					<i className="fas fa-search text-gray-400 mr-2"></i>
					<input type="text" placeholder="Start typing to search The LUG Blog" className="w-full py-2 bg-transparent focus:outline-none placeholder-gray-400 text-white" />
				</div>
			...
			<section className="relative flex flex-col items-center justify-center bg-black px-5 lg:px-0 pt-10 pb-40">
				...
				<div className="lg:w-4/5 border-t border-gray-400 pt-5 mt-20">
